---
name: drupal-reference
description: >
  Referencia de comandos, convenciones y buenas prácticas para desarrollo Drupal con DDEV.
  Consultar cuando se necesiten comandos drush, gestión de configuración, estilo de código
  o patrones de desarrollo Drupal.
---

# Referencia de Desarrollo Drupal

Este documento es una referencia operativa para proyectos Drupal con DDEV.
Consúltalo cuando necesites comandos, convenciones o buenas prácticas.
